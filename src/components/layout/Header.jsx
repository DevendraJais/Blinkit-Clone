  ...
  return (
    <header className="bg-white shadow-sm fixed top-0 left-0 right-0 z-50 w-full overflow-hidden">
      <div className="max-w-full mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18 md:h-20 w-full max-w-full">
          {/* Logo - Exact Blinkit Logo */}
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <a href="/" className="BlinkitLogo__LogoContainer-sc-xocpjl-0 bDRoQN">
          ...
          <div className="hidden md:flex flex-col items-start space-y-1">
            <div className="text-sm font-bold text-gray-900">Delivery in 10 minutes</div>
            <div className="flex items-center space-x-2 text-sm">
              <MapPin className="h-4 w-4 text-gray-500" />
              <select className="border-none focus:ring-0 text-sm font-medium">
          ...
          {/* Right Section - Blinkit Style */}
          <div className="Header__HeaderRight-sc-hejxrh-3 jxWZjl flex items-center space-x-4">
            {/* Login Button - Hidden on mobile */}
            <div className="hidden md:block ProfileButton__Container-sc-975teb-3 epnVke">
              <div className="ProfileButton__Text-sc-975teb-2 kBmsti px-6 py-2 text-primary-600 font-medium hover:text-primary-700 transition-colors cursor-pointer rounded-lg hover:bg-primary-50">
                Login
              </div>
            </div>
            
            {/* Cart Button */}
            <div className="CartButton__Container-sc-1fuy2nj-3 hfmoxQ">
              <div className="CartButton__Button-sc-1fuy2nj-5 iUafaq flex items-center space-x-2 px-4 py-2 text-primary-600 font-semibold hover:text-primary-700 transition-colors cursor-pointer">
                <div className="CartButton__CartIcon-sc-1fuy2nj-6 MVvDD relative">
                  <ShoppingCart className="h-6 w-6" />
                  <span className="absolute -top-1 -right-1 bg-primary-600 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center text-[10px]">
                    0
                  </span>
                </div>
                <div className="CartButton__Text-sc-1fuy2nj-4 jrWgyZ hidden sm:block">My Cart</div>
              </div>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 py-4">
            <div className="space-y-4">
              ...
              {/* Mobile Login */}
              <div className="ProfileButton__Container-sc-975teb-3 epnVke">
                <div className="ProfileButton__Text-sc-975teb-2 kBmsti px-6 py-2 text-primary-600 font-medium hover:text-primary-700 transition-colors cursor-pointer rounded-lg hover:bg-primary-50">
                  Login
                </div>
              </div>
