...
const FruitVegetableProductCard = ({ product }) => {
  return (
    <div 
      width="200" 
      className="ProductTypeCard__UpdatedProductTypeCardWrapper-sc-1ly7yxv-0 gWtUBI flex-shrink-0 h-full w-40 sm:w-48 md:w-56 lg:w-48 xl:w-56" 
      style={{
...
export default FruitVegetableProductCard;
